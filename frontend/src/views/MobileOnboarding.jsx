...
export function ConnectSheet({ close }) {
  ...
  return <>
    ...
    <div className="muted small" style={{ marginBottom: 14 }}>
      {t('Open Settings → “Pair the mobile app” on the Cospel site you’re already signed into, then enter its address and the code shown there.')}
    </div>
...
export default function MobileOnboarding() {
  ...
  return (
    <div className="narrow" style={wrap}>
      {head}
      <div className="muted" style={{ marginBottom: 34 }}>{t('How do you want to use Cospel?')}</div>
      ...
      <div className="dim small" style={{ marginTop: 26, lineHeight: 1.5 }}>
        {t('Local keeps everything on this phone. Connecting syncs to your own Cospel server instead — you can switch later in Settings.')}
      </div>
    </div>
  )
}
