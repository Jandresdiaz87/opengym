...
function PlanTools({ close }) {
  ...
  return <>
    ...
    <div className="dim small" style={{ margin: '7px 2px 0', lineHeight: 1.4 }}>{t('A small file a friend imports into their own Cospel — routines only, none of your workouts or weigh-ins.')}</div>
    <div style={{ height: 12 }} />
